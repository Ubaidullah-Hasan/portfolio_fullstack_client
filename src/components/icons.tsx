...
export const BackgroundOfMyImg: React.FC<IconSvgProps> = (props) => {
  const { width = 350, height = 350, className } = props;
  ...
  return (
    ...
    >
      ...
      <defs>
        ...
        >
          <stop offset="0" stopColor="#0994EA " stopOpacity="1" />
          <stop offset="0.48" stopColor="rgba(104, 226, 244)" stopOpacity="1" />
          <stop offset="1" stopColor="rgba(255, 255, 255)" stopOpacity="1" />
        </linearGradient>
      </defs>
    </svg>
  );
